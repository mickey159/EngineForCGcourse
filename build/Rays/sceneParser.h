...
struct SceneData
// the 4th number in the input objects is n, the power of V * R
// multiplication of normal and plane should be positive
// in general everything should be positive
// objects - last coordinate negative for plane, positive for sphere
{
